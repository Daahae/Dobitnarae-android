...
public class OrderListRecyclerAdapter2 extends RecyclerView.Adapter<OrderListRecyclerAdapter2.ViewHolder> {
    private Context context;
    private ArrayList<Order> orders;
    private Store store;

    public OrderListRecyclerAdapter2(Context context, ArrayList<Order> orders, Store store) {
